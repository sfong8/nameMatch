...
for file in os.listdir(filepath):
    ...
    x2 = x1[['MAF-COMCODE','MAF-ACCOUNT-MMCCYY','COUNTRY_OF_DISPATCH','COUNTRY_OF_ORIGIN','MAF-VALUE']]
...
master_df.to_csv('nonEU_imports.csv',index=None )
